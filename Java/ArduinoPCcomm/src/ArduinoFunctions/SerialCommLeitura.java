...
public class SerialCommLeitura implements Runnable, SerialPortEventListener
{
	...
	{
	/*	if(msg.equals("12")){ this.mode=2;System.out.println(mode);}*/
		if(escrita == true)
		{
			try{
			...
			try{
				...
				System.out.println("Enviando "+msg.getBytes().length +" byte(s) para "+Porta);
        		  ...
        		  try{
        			  ...
        			  if(novoDado == -1 ){ 
         				// bufferLeitura.append('\n');
          				 ...
          				 /********************************/
          				 if(aux.equals(aux1)){
          					/* nao consigo mudar variavel mode */
          					System.out.println(mode);
          					setMode(1);
          				    System.out.println("MOde ="+ getMode());
          					System.out.println("MODO QUERY");
          				 }
